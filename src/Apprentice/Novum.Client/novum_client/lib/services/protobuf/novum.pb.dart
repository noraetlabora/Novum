...
class InitializeRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('InitializeRequest',
      package: const $pb.PackageName('Novum.Server'))
    ..aOS(1, 'id')
    ..e<ClientType>(2, 'clientType', $pb.PbFieldType.OE, ClientType.ORDERMAN,
        ClientType.valueOf, ClientType.values)
    ..aOS(3, 'clientVersion')
  ...
  static InitializeRequest getDefault() =>
...
class InitializeReply extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('InitializeReply',
      package: const $pb.PackageName('Novum.Server'))
  ...
  factory InitializeReply.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory InitializeReply.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  InitializeReply clone() => InitializeReply()..mergeFromMessage(this);
  InitializeReply copyWith(void Function(InitializeReply) updates) =>
      super.copyWith((message) => updates(message as InitializeReply));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static InitializeReply create() => InitializeReply._();
  InitializeReply createEmptyInstance() => create();
  static $pb.PbList<InitializeReply> createRepeated() =>
      $pb.PbList<InitializeReply>();
  static InitializeReply getDefault() =>
      _defaultInstance ??= create()..freeze();
  static InitializeReply _defaultInstance;

  $core.int get unixTimestamp => $_get(0, 0);
  set unixTimestamp($core.int v) {
...
class LoginRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('LoginRequest',
      package: const $pb.PackageName('Novum.Server'))
    ..aOS(1, 'input')
    ..e<LoginInputType>(2, 'inputType', $pb.PbFieldType.OE,
        LoginInputType.MANUALLY, LoginInputType.valueOf, LoginInputType.values)
    ..hasRequiredFields = false;
  ...
  set inputType(LoginInputType v) {
    setField(2, v);
  }
...
class GetTablesRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetTablesRequest',
      package: const $pb.PackageName('Novum.Server'))
    ..hasRequiredFields = false;

  GetTablesRequest._() : super();
  factory GetTablesRequest() => create();
  factory GetTablesRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory GetTablesRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  ...
  static $pb.PbList<GetTablesRequest> createRepeated() =>
      $pb.PbList<GetTablesRequest>();
  static GetTablesRequest getDefault() =>
      _defaultInstance ??= create()..freeze();
  static GetTablesRequest _defaultInstance;
}

class GetTablesReply extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetTablesReply',
      package: const $pb.PackageName('Novum.Server'))
  ...
  factory GetTablesReply.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory GetTablesReply.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  GetTablesReply clone() => GetTablesReply()..mergeFromMessage(this);
  GetTablesReply copyWith(void Function(GetTablesReply) updates) =>
      super.copyWith((message) => updates(message as GetTablesReply));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static GetTablesReply create() => GetTablesReply._();
  GetTablesReply createEmptyInstance() => create();
  static $pb.PbList<GetTablesReply> createRepeated() =>
      $pb.PbList<GetTablesReply>();
...
class Tables extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo('Tables', package: const $pb.PackageName('Novum.Server'))
        ..pc<Table>(1, 'tables', $pb.PbFieldType.PM, Table.create)
        ..hasRequiredFields = false;

  Tables._() : super();
  factory Tables() => create();
  factory Tables.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Tables.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  Tables clone() => Tables()..mergeFromMessage(this);
  Tables copyWith(void Function(Tables) updates) =>
      super.copyWith((message) => updates(message as Tables));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Table extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo('Table', package: const $pb.PackageName('Novum.Server'))
        ..aOS(1, 'id')
        ..aOS(2, 'name')
        ..a<$core.double>(3, 'amount', $pb.PbFieldType.OD)
        ..aOS(4, 'waiterId')
        ..a<$core.int>(5, 'guests', $pb.PbFieldType.OU3)
        ..e<TableState>(6, 'state', $pb.PbFieldType.OE, TableState.ORDERED,
            TableState.valueOf, TableState.values)
        ..hasRequiredFields = false;
  ...
  $core.String get waiterId => $_getS(3, '');
  set waiterId($core.String v) {
    $_setString(3, v);
  }

  $core.bool hasWaiterId() => $_has(3);
  void clearWaiterId() => clearField(4);

  $core.int get guests => $_get(4, 0);
  set guests($core.int v) {
    $_setUnsignedInt32(4, v);
  }

  $core.bool hasGuests() => $_has(4);
  void clearGuests() => clearField(5);

  TableState get state => $_getN(5);
  set state(TableState v) {
    setField(6, v);
  }
...
class CancellationReasons extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CancellationReasons',
      package: const $pb.PackageName('Novum.Server'))
    ..pc<CancellationReason>(
        1, 'cancellationReasons', $pb.PbFieldType.PM, CancellationReason.create)
    ..hasRequiredFields = false;

  CancellationReasons._() : super();
  factory CancellationReasons() => create();
  factory CancellationReasons.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory CancellationReasons.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  CancellationReasons clone() => CancellationReasons()..mergeFromMessage(this);
  CancellationReasons copyWith(void Function(CancellationReasons) updates) =>
      super.copyWith((message) => updates(message as CancellationReasons));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static CancellationReasons create() => CancellationReasons._();
  CancellationReasons createEmptyInstance() => create();
  static $pb.PbList<CancellationReasons> createRepeated() =>
      $pb.PbList<CancellationReasons>();
  static CancellationReasons getDefault() =>
      _defaultInstance ??= create()..freeze();
...
class CancellationReason extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CancellationReason',
      package: const $pb.PackageName('Novum.Server'))
    ..aOS(1, 'id')
    ..aOS(2, 'name')
    ..hasRequiredFields = false;
  ...
  factory CancellationReason.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory CancellationReason.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  ...
  static $pb.PbList<CancellationReason> createRepeated() =>
      $pb.PbList<CancellationReason>();
  static CancellationReason getDefault() =>
      _defaultInstance ??= create()..freeze();
