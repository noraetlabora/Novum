...
class Table extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Table', package: const $pb.PackageName('Novum.Server'))
    ...
    ..e<TableState>(6, 'state', $pb.PbFieldType.OE, TableState.ORDERED, TableState.valueOf, TableState.values)
    ..hasRequiredFields = false
  ;
...
class Theme extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Theme', package: const $pb.PackageName('Novum.Server'))
    ..a<$core.int>(1, 'primary', $pb.PbFieldType.OU3)
    ..a<$core.int>(2, 'primaryVariant', $pb.PbFieldType.OU3)
    ..a<$core.int>(3, 'secondary', $pb.PbFieldType.OU3)
    ..a<$core.int>(4, 'secondaryVariant', $pb.PbFieldType.OU3)
    ..a<$core.int>(10, 'background', $pb.PbFieldType.OU3)
    ..a<$core.int>(11, 'surface', $pb.PbFieldType.OU3)
    ..a<$core.int>(20, 'onPrimary', $pb.PbFieldType.OU3)
    ..a<$core.int>(21, 'onSecondary', $pb.PbFieldType.OU3)
    ..a<$core.int>(22, 'onBackground', $pb.PbFieldType.OU3)
    ..a<$core.int>(23, 'onSurface', $pb.PbFieldType.OU3)
    ..hasRequiredFields = false
  ;
  ...
  static Theme getDefault() => _defaultInstance ??= create()..freeze();
  static Theme _defaultInstance;

  $core.int get primary => $_get(0, 0);
  set primary($core.int v) { $_setUnsignedInt32(0, v); }
  $core.bool hasPrimary() => $_has(0);
  void clearPrimary() => clearField(1);

  $core.int get primaryVariant => $_get(1, 0);
  set primaryVariant($core.int v) { $_setUnsignedInt32(1, v); }
  $core.bool hasPrimaryVariant() => $_has(1);
  void clearPrimaryVariant() => clearField(2);

  $core.int get secondary => $_get(2, 0);
  set secondary($core.int v) { $_setUnsignedInt32(2, v); }
  $core.bool hasSecondary() => $_has(2);
  void clearSecondary() => clearField(3);

  $core.int get secondaryVariant => $_get(3, 0);
  ...
  $core.int get background => $_get(4, 0);
  set background($core.int v) { $_setUnsignedInt32(4, v); }
  $core.bool hasBackground() => $_has(4);
  void clearBackground() => clearField(10);

  $core.int get surface => $_get(5, 0);
  set surface($core.int v) { $_setUnsignedInt32(5, v); }
  $core.bool hasSurface() => $_has(5);
  void clearSurface() => clearField(11);

  $core.int get onPrimary => $_get(6, 0);
  set onPrimary($core.int v) { $_setUnsignedInt32(6, v); }
  $core.bool hasOnPrimary() => $_has(6);
  void clearOnPrimary() => clearField(20);

  $core.int get onSecondary => $_get(7, 0);
  set onSecondary($core.int v) { $_setUnsignedInt32(7, v); }
  $core.bool hasOnSecondary() => $_has(7);
  void clearOnSecondary() => clearField(21);

  $core.int get onBackground => $_get(8, 0);
  set onBackground($core.int v) { $_setUnsignedInt32(8, v); }
  $core.bool hasOnBackground() => $_has(8);
  void clearOnBackground() => clearField(22);

  $core.int get onSurface => $_get(9, 0);
  set onSurface($core.int v) { $_setUnsignedInt32(9, v); }
  $core.bool hasOnSurface() => $_has(9);
  void clearOnSurface() => clearField(23);
}
