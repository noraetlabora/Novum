...
namespace Os.Server.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class ToolbarPaymentConfig : IEquatable<ToolbarPaymentConfig>
    {
        /// <summary>
        ...
        public List<TBPaymentConfig> Buttons { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ToolbarPaymentConfig {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ToolbarPaymentConfig)obj);
        }

        /// <summary>
        /// Returns true if ToolbarPaymentConfig instances are equal
        /// </summary>
        /// <param name="other">Instance of ToolbarPaymentConfig to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ToolbarPaymentConfig other)
        {
...
#pragma warning disable 1591
        ...
        public static bool operator ==(ToolbarPaymentConfig left, ToolbarPaymentConfig right)
        {
