...
{
    public class SVS_viaFactory : IBookingSystem
    {
        public NtBooking.BookingSystemType Type { get => NtBooking.BookingSystemType.SVS; set => throw new NotImplementedException(); }
        private SvsSoapClient svsSoapClient;

        public SVS_viaFactory(string uri, string username, string password, int timeout)
        {
