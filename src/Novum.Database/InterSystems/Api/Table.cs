...
namespace Novum.Database.InterSystems.Api
{
    ...
    internal class Table : IDbTable
    {
        ...
        /// </summary>
        /// <returns></returns>
        public Dictionary<string, Novum.Data.Table> GetTables(Session session)
        {
            ...
            foreach (string tableString in tablesArray)
            {
                ...
                var table = new Novum.Data.Table();
                var dataString = new Novum.Data.Utils.DataString(tableString);
        ...
        /// <returns></returns>
        public string GetTableId(Session session, string tableName)
        {
        ...
        /// <returns></returns>
        public string GetTableName(Session session, string tableId)
        {
        ...
        /// <param name="tableId"></param>
        /// <returns></returns>
        public string GetNewSubTableId(Session session, string tableId)
        {
        ...
        /// <param name="session"></param>
        /// <param name="tableId"></param>
        public void OpenTable(Session session, string tableId)
        {
        ...
        /// <param name="session"></param>
        /// <param name="tableId"></param>
        public void UnlockTable(Session session, string tableId)
        {
