...
namespace Os.Server.Models
{
    ...
    {
        /// <summary>
        /// List of order line payments that represent the orderlines (-parts) that will be paid with this set.
        /// </summary>
        /// <value>List of order line payments that represent the orderlines (-parts) that will be paid with this set.</value>
