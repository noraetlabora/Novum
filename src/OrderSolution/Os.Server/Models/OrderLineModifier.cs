...
{ 
    ...
    { 
        ...
        /// <summary>
        /// The ID of the FaxInput image. Can be a number, url, ... The format if this ID is defined by the POS storage behavior. TODO: When the FaxInput storage API is defined we may have to update 
        /// </summary>
        /// <value>The ID of the FaxInput image. Can be a number, url, ... The format if this ID is defined by the POS storage behavior. TODO: When the FaxInput storage API is defined we may have to update </value>
