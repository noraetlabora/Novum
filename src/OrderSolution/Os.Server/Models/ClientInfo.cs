...
namespace Os.Server.Models
{
    ...
    public partial class ClientInfo : IEquatable<ClientInfo>
    {
        ...
        /// <summary>
        /// The id of the remote client we are talking to. (should consist of an application name + device serial number)
        /// </summary>
        /// <value>The id of the remote client we are talking to. (should consist of an application name + device serial number)</value>
        [DataMember(Name = "id")]
        ...
        /// <summary>
        /// Optional. A path to the printer that can be used for send print jobs to this client if it supports them. For Orderman handheld devices this path will be provided if an Orderman belt printer is paired with that device. To send print jobs you can use the \&quot;/printers\&quot; API of the OsServer instance this initialization request was coming from. Example (we assume the OsServer is running on local host and it&#39;s httpApi port is configured to 12344:     - You receive the path \&quot;/printers/125-49944541\&quot;     - You can query details about this printer via \&quot;GET http://localhost:12344/api/v1/printers/125-49944541\&quot;     - To send a new print job: \&quot;POST http://localhost:12344/api/v1/printers/125-49944541/jobs\&quot; which will return        with a print job id immediately (in this example 38428)     - to query the print job status: \&quot;GET http://localhost:12344/api/v1/printers/125-49944541/jobs/38428\&quot;
        /// </summary>
        /// <value>Optional. A path to the printer that can be used for send print jobs to this client if it supports them. For Orderman handheld devices this path will be provided if an Orderman belt printer is paired with that device. To send print jobs you can use the \&quot;/printers\&quot; API of the OsServer instance this initialization request was coming from. Example (we assume the OsServer is running on local host and it&#39;s httpApi port is configured to 12344:     - You receive the path \&quot;/printers/125-49944541\&quot;     - You can query details about this printer via \&quot;GET http://localhost:12344/api/v1/printers/125-49944541\&quot;     - To send a new print job: \&quot;POST http://localhost:12344/api/v1/printers/125-49944541/jobs\&quot; which will return        with a print job id immediately (in this example 38428)     - to query the print job status: \&quot;GET http://localhost:12344/api/v1/printers/125-49944541/jobs/38428\&quot;</value>
